...
# 528 Random Pick with Weight 将随机概率变成 平均概率

<img src="501 - 600.assets/image-20210214174642033.png" alt="image-20210214174642033" style="zoom:50%;" />

```java
/*
		ref: https://github.com/wisdompeak/LeetCode/blob/master/Math/528.Random-Pick-with-Weight/528.Random-Pick-with-Weight.cpp
		
		举个例子， 比如
		[1,2,3,2,1,4,2]
		 0 1 2 3 4 5 6  这是所对应的索引位置
...
/**
	思路是 如果有括号，就褪括号， 这样可以减少 corner cases 的判定
 */
class Solution {
public:
    TreeNode* str2tree(string s) {
        ...
        TreeNode* root = new TreeNode(stoi(s.substr(0, leftP)));
        int leftCount = 1;
        int i = leftP + 1;
        for(; i < s.size(); i++){
            if(s[i] == '(')
        ...
        cout << " ? " << endl;
        cout << s.substr(leftP, i - leftP + 1) << endl;
        cout << s.substr(i + 1) << endl;
        root->left  = str2tree(s.substr(leftP, i - leftP + 1));
        root->right = str2tree(s.substr(i + 1));
...
![image-20210804090401731](501 - 600.assets/image-20210804090401731.png)
...
<img src="501 - 600.assets/image-20210907211914944.png" alt="image-20210907211914944" style="zoom:50%;" />
